...
func init() {
	...
	icons = append(icons, makeIds(100, 129)...)
	icons = append(icons, makeIds(200, 226)...)
	icons = append(icons, makeIds(300, 339)...)
	icons = append(icons, makeIds(400, 419)...)
	icons = append(icons, makeIds(500, 511)...)
	icons = append(icons, makeIds(600, 619)...)
	icons = append(icons, makeIds(700, 734)...)
	icons = append(icons, makeIds(800, 809)...)
	icons = append(icons, makeIds(900, 918)...)
}

func makeIds(min int, max int) []int {
	length := max - min
	ids := make([]int, length)
...
func getRandomItem[T any](array []T) T {
